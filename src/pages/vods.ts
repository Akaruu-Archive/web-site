...
router.get('/', async (req, res) => {
  ...
  //   let getdatas = await getAllData("vods", "createAt", -1, 21);
  ...
  //     datas +=
  //       `
  //       <div class="item" onclick="Aclick(2, '${getdatas[i]._id}')">
  ...
  //       <title>Akaruu Archive | Vods</title>
  //       <style>${css}</style>
  //       <style>${allCss}</style>
  //       <script>${btnMore + click}</script>
  //       <link rel="icon" href="/favicon.ico" type="image/x-icon">
  //       <meta name="viewport" content="width=device-width, initial-scale=1.0">
  //       <meta property="og:title" content="Akaruu Archive | vods">
  ...
  //       ${headerHtml}
  //       <div class="app">
  //         <div class="title">Les vods les plus récents :</div>
  //         <div class="list" id="list">${datas}</div>
  //         <div class="prebtnvid">
  //           <div class="btnvid" onclick="btnMore(2);">Plus de vods</div>
  //         </div>
  //       </div>
  //       ${footerHtml}
  //     </body>
  ...
  //   let data = await getData("vods", watch)
  //   res.send(`
  //     <!DOCTYPE html>
  //     <html lang="fr">
  //     <head>
  ...
  //       <meta property="og:url" content="/vods?watch=${watch}">
  //       <meta property="og:type" content="website">
  //       <meta property="og:site_name" content="Akaruu Archive">
  //       <meta name="twitter:card" content="summary_large_image">
  ...
  //         </div>
  //         <div class="right">
  //           <div class="title">Titre de la vod : ${data.title}</div>
